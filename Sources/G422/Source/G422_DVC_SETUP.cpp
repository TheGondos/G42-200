...
{
	{ MGID_SW3_GEAR,          SW3_MID,     _V(-0.100566, 2.24176, 38.9565),     _V(0, 2.23281, 38.9669),          _X  },
	{ MGID_SW3_CANARD,        SW3_MID,     _V(-0.0795636, 2.24176, 38.9565),    _V(0, 2.23281, 38.9669),          _X  },
	{ MGID_SW3_VISOR,         SW3_MID,     _V(-0.0607121, 2.24176, 38.9565),    _V(0, 2.23281, 38.9669),          _X  },
	{ MGID_SW3_RCS,           SW3_MID,     _V(-0.0420616, 2.24176, 38.9565),    _V(0, 2.23281, 38.9669),          _X  },

	{ MGID_SW2_LGT_NAV,       SW2_DOWN,    _V(-0.133736, 2.80125, 39.0016),     _V(0, 2.80711, 39.0082),          _Xn },
	{ MGID_SW2_LGT_STB,       SW2_DOWN,    _V(-0.112913, 2.80125, 39.0016),     _V(0, 2.80711, 39.0082),          _Xn },
	{ MGID_SW2_LGT_BCN,       SW2_DOWN,    _V(-0.0920897, 2.80125, 39.0016),    _V(0, 2.80711, 39.0082),          _Xn },
	{ MGID_SW2_LGT_LND,       SW2_DOWN,    _V(-0.0504438, 2.80125, 39.0016),    _V(0, 2.80711, 39.0082),          _Xn },
	{ MGID_SW2_LGT_TAX,       SW2_DOWN,    _V(-0.0310962, 2.80125, 39.0016),    _V(0, 2.80711, 39.0082),          _Xn },
	{ MGID_SW2_LGT_DCK,       SW2_DOWN,    _V(-0.0106556, 2.80125, 39.0016),    _V(0, 2.80711, 39.0082),          _Xn },
	...
	{ MGID_SW3_APU_HYD,       SW3_MID,     _V(0.0143213, 2.16742, 38.5745),     _V(-0.0056787, 2.16742, 38.5745), _X  },

	{ MGID_SW3_EMAIN_IGN,     SW3_DOWN,    _V(-0.0779257, 2.22507, 38.9223),    _V(-0.0883789, 2.21386, 38.9235), _X  },
	{ MGID_SW3_EMAIN_MODE,    SW3_MID,     _V(-0.0779257, 2.21515, 38.866),     _V(-0.0786392, 2.20551, 38.8738), _X  },
	{ MGID_SW3_EMAIN_REHEAT,  SW2_DOWN,    _V(-0.0779257, 2.20629, 38.8118),    _V(-0.0786391, 2.19797, 38.818),  _X  },
	...
	{ MGID_SW3_BAY_OPENCLSE,  SW3_MID,     _V(-0.166489, 2.85702, 38.901),      _V(-0.146489, 2.85702, 38.901),   _Xn },

	{ MGID_SW2_LEFT_DUMP,     SW2_DOWN,    _V(-0.345545, 2.91967, 38.7197),     _V(-0.325545, 2.91967, 38.7197),  _Xn, 0.5 },
	{ MGID_SW2_FWD_DUMP,      SW2_DOWN,    _V(-0.326214, 2.91967, 38.7197),     _V(-0.306214, 2.91967, 38.7197),  _Xn, 0.5 },
	{ MGID_SW2_AFT_DUMP,      SW2_DOWN,    _V(-0.305849, 2.91967, 38.7197),     _V(-0.285849, 2.91967, 38.7197),  _Xn, 0.5 },
	{ MGID_SW2_RIGHT_DUMP,    SW2_DOWN,    _V(-0.28535, 2.91967, 38.7197),      _V(-0.26535, 2.91967, 38.7197),   _Xn, 0.5 },
	{ MGID_SW2_ASF_DUMP,      SW2_DOWN,    _V(-0.265586, 2.91967, 38.7197),     _V(-0.245586, 2.91967, 38.7197),  _Xn, 0.5 },
	{ MGID_SW2_OXY_DUMP,      SW2_DOWN,    _V(-0.245177, 2.91967, 38.7197),     _V(-0.225177, 2.91967, 38.7197),  _Xn, 0.5 },
	{ MGID_SW2_MASTER_DUMP,   SW2_DOWN,    _V(-0.342558, 2.90107, 38.772),      _V(-0.322558, 2.90107, 38.772),   _Xn, 0.5 },

	{ MGID_SW2_DCKSPL_FUEL,   SW2_DOWN,    _V(0.120339, 2.83445, 38.9593),      _V(0.100339, 2.83445, 38.9593),   _Xn, 0.5 },
	{ MGID_SW2_DCKSPL_OXY,    SW2_DOWN,    _V(0.141654, 2.83445, 38.9593),      _V(0.121654, 2.83445, 38.9593),   _Xn, 0.5 },
	{ MGID_SW2_DCKSPL_ASF,    SW2_DOWN,    _V(0.161634, 2.83445, 38.9593),      _V(0.141634, 2.83445, 38.9593),   _Xn, 0.5 }
};

VCKnobDef VC_kbDefs[VC_KNOB_COUNT] =
{
	{ MGID_KB3_ACS_MODE,  KB3_DOWN, _V(0.199, 2.351, 39.077),        _V(0.0243076, 0.626733, -0.778855),   0.03,  float(-95 * RAD), 0,  0.67 },
	{ MGID_KB3_RCS_MODE,  KB3_DOWN, _V(0.247, 2.351, 39.077),        _V(-0.0243061, 0.626731, -0.778857),  0.03,  float(75 * RAD),  0,  0.45 },
	{ MGID_KB2_COORD_REF, KB2_DOWN, _V(0.166, 2.38, 39.097),         _V(0, 0.739668, -0.672971),           0.03,  float(PI),        0 },

	{ MGID_KB2_LENG_FEED, KB2_DOWN, _V(0.0688978, 2.86922, 38.8607), _V(0.00108671, -0.950117, -0.311893), 0.008, float(PI05),      1 },
	{ MGID_KB2_RAMX_FEED, KB2_DOWN, _V(0.115558, 2.86914, 38.8611),  _V(0.00108671, -0.950117, -0.311893), 0.008, float(PI05),      1 },
	{ MGID_KB2_RENG_FEED, KB2_DOWN, _V(0.162308, 2.86903, 38.8616),  _V(0.00108671, -0.950117, -0.311893), 0.008, float(PI05),      1 },

	{ MGID_KB2_RCS_FEED,  KB2_DOWN, _V(0.0538829, 2.9097, 38.7466),  _V(0.00108671, -0.950117, -0.311893), 0.008, float(PI05),      1 },
	{ MGID_KB2_OMS_FEED,  KB2_DOWN, _V(0.0851828, 2.9097, 38.7467),  _V(0.00108671, -0.950117, -0.311893), 0.008, float(PI05),      1 },
	{ MGID_KB2_APU_FEED,  KB2_DOWN, _V(0.115267, 2.9097, 38.7468),   _V(0.00108671, -0.950117, -0.311893), 0.008, float(PI05),      1 },

	{ MGID_KB2_LOXY_FEED, KB2_DOWN, _V(0.146261, 2.9097, 38.7469),   _V(0.00108671, -0.950117, -0.311893), 0.008, float(PI05),      1 },
	{ MGID_KB2_ROXY_FEED, KB2_DOWN, _V(0.176345, 2.9097, 38.747),    _V(0.00108671, -0.950117, -0.311893), 0.008, float(PI05),      1 }
};
...
bool G422::clbkLoadVC(int id)
{
	...
	for (i = 0; i < VC_KNOB_COUNT; ++i)
	{
		...
		oapiVCSetAreaClickmode_Spherical((VC_CTRLSET_KNOBS << 16) | (i & 0xFFFF), VC_kbDefs[i].refPos, VC_kbDefs[i].size);
	}

	// VC button buildup
	for (i = 0; i < VC_BUTTON_COUNT; ++i)
	{
		oapiVCRegisterArea((VC_CTRLSET_BUTTONS << 16) | (i & 0xFFFF), _R(0, 0, 0, 0), PANEL_REDRAW_NEVER, PANEL_MOUSE_LBDOWN | PANEL_MOUSE_RBDOWN, PANEL_MAP_NONE, NULL);
