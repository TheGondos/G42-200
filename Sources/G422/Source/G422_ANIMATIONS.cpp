...
#define POSDIR_PRK_BRK_HNDL _V(0.531, 2.36865, 39.0992), _V(0.01941, 0.64332, -0.765351)
...
void G422::setupAnimations()
{
	...
	bayDoors = new MovingPart(an_cgoBay, 0.01, MP_LOW_DETENT, 0.0, this, G422_SYSID_BAY);
