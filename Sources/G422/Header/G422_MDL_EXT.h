...
{
{ { 0.0, -5.16009, 34.7891 }, 3e6, 3e5, 1.6, 0.1},
{ { -5.25783, -5.74195, -4.22095 }, 3e6, 3e5, 3.0, 0.2},
{ { 5.25783, -5.74195, -4.22095 }, 3e6, 3e5, 3.0, 0.2},

{ { -22.9,-1.16,-20.74 }, 3e7, 3e5, 3.0},
{ { 22.9,-1.16,-20.74 }, 3e7, 3e5, 3.0},

{ { -22.62,-1.2,-18.66 }, 3e7, 3e5, 3.0},
{ { 22.62,-1.2,-18.66 }, 3e7, 3e5, 3.0},

{ { -22.36,-1.04,-18.7 }, 3e7, 3e5, 3.0},
{ { 22.36,-1.04,-18.7 }, 3e7, 3e5, 3.0},

{ { -22.9,-1.16,-20.74 }, 3e7, 3e5, 3.0},
{ { 22.9,-1.16,-20.74 }, 3e7, 3e5, 3.0},

{ { -0.35,1.1,-41.8}, 3e7, 3e5, 3.0},
{ { 0.35,1.1,-41.8}, 3e7, 3e5, 3.0},

{ { -0.4,1.92,-41.8}, 3e7, 3e5, 3.0},
{ { 0.4,1.92,-41.8}, 3e7, 3e5, 3.0},

{ { 0,2.9,39.3 }, 3e7, 3e5, 3.0},
{ { 0,1,42.9 }, 3e7, 3e5, 3.0}
};

static const TOUCHDOWNVTX TOUCHDOWN_GEARUP[TOUCHDOWN_COUNT] =
{
{ { 0.0, -3.90729, 8.8675 }, 3e6, 3e5, 1.6, 0.1},
{ { -3.112, -4.10324, -5.54899 }, 3e6, 3e5, 3.0, 0.2},
{ { 3.112, -4.10324, -5.54899 }, 3e6, 3e5, 3.0, 0.2},
...
#define V3_BAY_ATTACH_001 _V(0.0, 0.26, 30.13)
#define V3_BAY_ATTACH_002 _V(0.0, 0.26, 28.53)
#define V3_BAY_ATTACH_003 _V(0.0, 0.26, 26.93)
#define V3_BAY_ATTACH_004 _V(0.0, 0.26, 25.33)
#define V3_BAY_ATTACH_005 _V(0.0, 0.26, 23.73)
#define V3_BAY_ATTACH_006 _V(0.0, 0.26, 22.13)
#define V3_BAY_ATTACH_007 _V(0.0, 0.26, 20.53)
#define V3_BAY_ATTACH_008 _V(0.0, 0.26, 18.93)
...
#define MGID_ANT_DISH 0
#define MGID_BAY_DOOR_L 1
#define MGID_BAY_DOOR_INT_L 2
#define MGID_CANARD_COVER_L 3
#define MGID_CANARD_DOOR_L 4
#define MGID_CANARD_WING_L 5
#define MGID_Cylinder001 6
#define MGID_BAY_DOOR_R 7
#define MGID_BAY_DOOR_INT_R 8
#define MGID_Box002 9
#define MGID_CANARD_COVER_R 10
#define MGID_CANARD_DOOR_R 11
#define MGID_CANARD_WING_R 12
#define MGID_Line002 13
#define MGID_Object009 14
#define MGID_Object010 15
#define MGID_Object017 16
#define MGID_Object030 17
#define MGID_Object129 18
#define MGID_Object1238 19
#define MGID_Object1291 20
#define MGID_RAMX_LOWER_SLAT 21
#define MGID_RAMX_UPPER_SLAT 22
#define MGID_VISOR_EXT_AFT 23
#define MGID_VISOR_EXT_FORE 24
#define MGID_WING_ACS_INB_R 25
#define MGID_WING_FTHR_L 26
#define MGID_WING_WRDROP_TIP_L 27
#define MGID_WING_ACS_OUT_L 28
#define MGID_WING_FTHR_R 29
#define MGID_WING_WRDROP_TIP_R 30
#define MGID_WING_ACS_OUT_R 31
#define MGID_GEAR_DOOR_C_AL 32
#define MGID_GEAR_DOOR_C_AR 33
#define MGID_GEAR_DOOR_C_FL 34
#define MGID_GEAR_DOOR_C_FR 35
#define MGID_GEAR_DOOR_L 36
#define MGID_GEAR_DOOR_R 37
#define MGID_GEAR_FRAME_L 38
#define MGID_GEAR_FRAME_R 39
#define MGID_GEAR_HATCH_L 40
#define MGID_GEAR_HATCH_R 41
#define MGID_GEAR_STRUT_C 42
#define MGID_GEAR_TRUCK_C 43
#define MGID_GEAR_STRUT_L 44
#define MGID_GEAR_STRUT_R 45
#define MGID_GEAR_TRUCK_R 46
#define MGID_GEAR_TRUCK_L 47
#define MGID_MAIN_INTAKE_DOORS 48
#define MGID_Object019 49
#define MGID_Object034 50
#define MGID_Object038 51
#define MGID_Object047 52
#define MGID_Object356 53
#define MGID_Object1225 54
#define MGID_Object1275 55
#define MGID_Object1328 56
#define MGID_Object1346 57
#define MGID_Object1386 58
#define MGID_RAMX_DOOR 59
#define MGID_RCS_DOOR_L 60
#define MGID_RCS_DOOR_R 61
#define MGID_RCS_THRUSTERS_R 62
#define MGID_RCS_THRUSTERS_L 63
#define MGID_RUDDER 64
#define MGID_TAIL_WHEEL 65
#define MGID_TAILWHEEL_DOOR_L 66
#define MGID_TAILWHEEL_DOOR_R 67
#define MGID_WING_ACS_INB_L 68
#define MGID_WINGS 69
